    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(30000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                count.setText("Resend Code within " + millisUntilFinished / 1000 + " Seconds");
            }
                ...
                .addOnCompleteListener(VerifyPhoneActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(VerifyPhoneActivity.this,FoodMenuActivity.class);
                            startActivity(intent);
                            finish();


                        } else {
                            ReusableCodeForAll.ShowAlert(VerifyPhoneActivity.this,"Error",task.getException().getMessage());
                        }
                    }
                });
    }
